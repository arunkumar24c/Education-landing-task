...
const Footer = () => {
  return (
    ...
    >
      <div className="grid md:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 place-items-start gap-8 text-white bg-black">
        <div>
        ...
        <div>
          ...
          <div className="text-sm mb-4">xxxxxx@gmail.com</div>
